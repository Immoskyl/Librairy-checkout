...
public class GUI 
{
	...
	protected void reviewCustomer()
	{
		...
		enter.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if (name.equals(history.get(i)))
					{
						list += history.get(i).getName() + ", " + history.get(i).getGame() + ", " + history.get(i).getPrice() + " \n";
	...
	public void removeCustomer()
	{
		...
		JLabel name = new JLabel ("Name: ", SwingConstants.LEADING);
		JTextField nameOfCustomer = new JTextField();
		JButton enter = new JButton("Enter");
		JButton cancel = new JButton("Cancel");
		enter.addActionListener(new ActionListener() 
		{
			...
			{							
				...
				File tempFile = new File("tempCustomers.csv");
				...
				String currentLine;
				String customerRemove = nameOfCustomer.getText();
//				System.out.println("Staff Member Removed");
				...
				try 
				{
					while((currentLine = reader.readLine()) != null)
					{
						// trim newline when comparing with lineToRemove 
						String trimmedLine = currentLine.trim();
						if(trimmedLine.equals(customerRemove)) continue;
						writer.write(currentLine + System.getProperty("line.separator"));
					}
				} catch (IOException e1) 
				{
	...
	public void removeStaff()
	{
		...
		enter.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{							
				File inputFile = new File("Staff.csv");
				File tempFile = new File("tempStaff.csv");
				...
				String currentLine;
				String staffRemove = nameOfStaff.getText();
//				System.out.println("Staff Member Removed");
				...
				try
				{
					while((currentLine = reader.readLine()) != null)
					{
						// trim newline when comparing with lineToRemove 
						String trimmedLine = currentLine.trim();
						if(trimmedLine.equals(staffRemove)) continue;
						writer.write(currentLine + System.getProperty("line.separator"));
					}
				} catch (IOException e1)
				{
	...
	public void startUp()
	{
		...
		history = manage.readHistory("History.csv");
	}
	...
	public void closeDown()
	{
		...
		manage.writeHistory("History.csv", history);
	}
}