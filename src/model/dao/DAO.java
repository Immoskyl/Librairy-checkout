...
public class DAO implements IDAO{
    ...
    /**
     * createUser
     * create a PERSON tuple from a newUser
     * @param person
     */
    ...
    /**
     * deleteUser
     * delete a PERSON tuple sharing the ID of a given newUser (primary key value)
     * @param person
     */
    ...
    /**
     * getAllUsers
     * select all the person tuples and instanciate as many newUsers from them
     * @return List<newUsers> users
     */
    ...
    /**
     * getUser
     * instanciates the newUser with values from the PERSON tuple mathing given ID
     * @param iD
     * @return newUser user
     */
    ...
    /**
     * updateUsers
     * verry basic and unsafe implementation
     * update db PERSON tuples according to the current users objects living in the system
     * @param users
     */
    public void updateUsers (List<newUser> users) {
    ...
    /**
     * getUserType
     * return the type of an user (matched by its ID)
     * @param dbType
     * @return String type (in the format used by Shane in UserFactory)
     */
    public String getUserType (int dbType) {
        ...
        switch (selectionQuery("PERSONTYPE", rowList, argList, rowCondition, argCondition).get(0)) {
            case "ADMINISTRATOR":
                return "a";
            case "EMPLOYEE":
                return "e";
    ...
    /**
     * createProduct
     * create a PRODUCT tuple according to a system Product
     * @param product
     */
